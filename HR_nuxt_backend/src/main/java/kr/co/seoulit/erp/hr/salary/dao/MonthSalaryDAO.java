...
public interface MonthSalaryDAO {
	...
	public ArrayList<MonthSalaryTO> selectMonthSalaryList(HashMap<String,Object> param);
	...
	public ArrayList<MonthSalaryTO> selectMonthSalaryList(@Param("applyYearMonth") String applyYearMonth, @Param("empCode") String empCode,@Param("deptCode")String deptCode);
